    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-500 via-gaming-500 to-eco-500 flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:info@coeurnumerique.ca" className="hover:text-white transition-colors">
                  info@coeurnumerique.ca
                </a>
              </li>
              <li>
                <a href="tel:+15141234567" className="hover:text-white transition-colors">
                  (514) 123-4567
                </a>
              </li>
            </ul>
            <div className="mt-4">
              <h4 className="font-semibold text-white mb-2 text-sm">{t('footer.follow')}</h4>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Cœur Numérique. {t('footer.rights')}.</p>
        </div>
      </div>
    </footer>
  );
